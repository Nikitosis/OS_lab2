...
This project uses Maven for **all tasks except #4**:

`mvn spring-boot:run`

`mvn test`

**Task #4** is a regular Java project, with its main class being `com.spos.lab2.task4.ProducerConsumerMain`.
